...
//   // Fetch comments, likes, bookmarks, helpfuls when posts or currentUser changes
//   useEffect(() => {
...
//         {dropdownOpen && (
//           <div
//             className="position-absolute end-0 mt-5 me-2 bg-white border rounded shadow-sm z-3"
...
//         </button>
//       </div>
//       <h2 className="mb-4">Travel Stories</h2>
...
//                     <img
//                       key={index}
//                       src={`http://localhost:5000${post.images[img]}`}
...
//                       bookmarks[post.id] ? 'btn-warning' : 'btn-outline-warning'
//                     }`}
...
//                   <button
//                     className={`btn btn-sm me-2 ${
//                       helpfuls[post.id]?.marked ? 'btn-success' : 'btn-outline-success'
//                     }`}
...
//                     <div key={c.id} className="mt-2 border-bottom">
  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="mb-0">Travel Stories</h2>
